    ...
    public static void loadRecipes() {
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemInputs(
                ...
                ItemList.LatheUHV.get(32),//Changed to Lathe as Slicing Machine is removed
                eM_Power.get(16),
        ...
        if (Config.Enable_BallLightning) {
            ...
            GTValues.RA
                ...
                .itemInputs(
                    ...
                    GTOreDictUnificator.get(OrePrefixes.itemCasing, Materials.TranscendentMetal, 64),
                    //new ItemStack(ModItems.ChargePack_UHV, 1),
                    new ItemStack[]{ GregtechItemList.ChargePack_UHV.get(1) },
                    ItemList.ZPM5.get(1),
                    GTOreDictUnificator.get(OrePrefixes.itemCasing, Materials.TranscendentMetal, 64)
                )
                .fluidInputs(
